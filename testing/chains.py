...
class Chain:
    ...
    def resume_jd_match(self, resume_info=None, job_info=None):
        prompt_chat = PromptTemplate.from_template(
            ...
            Provide an intelligent and helpful response based on below template to the user’s query. 
            Tailor the response based on resume and job info are provided.
            ### RESPONSE:
            
            Provide the response STRICTLY in the following JSON format NO PREAMBLE:
