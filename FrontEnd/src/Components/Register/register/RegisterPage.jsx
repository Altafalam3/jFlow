                ...
                <div>
                    <div className={style.rightRegister}>
                        <Box className={style.rightRegisterBox}>
                            ...
                            >
                                <FormControl
                                    className={style.rightRegisterForm}
                                >
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        />
                                        <FormHelperText>
                                            We'll send you relevant jobs in your
                                            mail
                                        </FormHelperText>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <FormHelperText>
                                            Recruiters will call you on this
                                            number
                                        </FormHelperText>
                                    </div>
                                    <div>
                                        ...
                                        <div
                                            className={
                                                style.rightRegisterBoxInputDiv
                                            }
                                        >
                                            <label
                                                htmlFor="files"
                                                className={
                                                    style.rightRegisterBoxInputBtn
                                                }
                                            >
                                                Upload Resume
                                            </label>
                                            ...
                                            <div>
                                                <Text
                                                    ...
                                                    color="#8d8aad"
                                                >
                                                    DOC, DOCx, PDF, RTF | Max: 2
                                                    MB
                                                </Text>
                                            </div>
                                        </div>
                                        <FormHelperText>
                                            Recruiters give first preference to
                                            candidates who have a resume
                                        </FormHelperText>
                                    </div>
                                    <div>
                                        <Button
